...
from tensordb.zarr_v3.v2.meta import Metadata2
from tensordb.zarr_v3.v2.util import normalize_storage_path
...
class BaseStore(MutableMapping[str, Any]):
    ...
    def _ensure_store(store: Any):
        ...
        """
        from tensordb.zarr_v3.v2.storage import KVStore  # avoid circular import
