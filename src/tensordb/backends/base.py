...
from tensordb.branch_store.base import BranchStorage
...
class BaseBackend:
    """
    Obligatory interface used for the Backend classes created, this defines the abstract methods
    for every Backend and allow their use with TensorClient.

    Parameters
    ----------

    store: BaseStore
        It's the same parameter that you send to the :meth:`TensorClient.__init__`
        (TensorClient send it automatically)
