from typing import Dict, Any, List, Literal, Union, Type

import xarray as xr
from pydantic import BaseModel

from tensordb.backends.base import BaseBackend
from tensordb.branch_storage.base import BaseBranchStorage


class CachedStorage(BaseBackend):
    """
    ...
    def upsert(self, new_data: Union[xr.DataArray, xr.Dataset], **kwargs) -> List[
